package com.example.estudiantesUniversidad;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

@SpringBootApplication
public class EstudiantesUniversidadApplication {

	public static void main(String[] args) {

		SpringApplication.run(EstudiantesUniversidadApplication.class, args);

		/**
		 * Ejercicio Nº 1:

		 * Crear una API que gestione los datos de estudiantes de una universidad y que devuelva una lista ordenada
		 * de acuerdo con su rendimiento académico en la materia “Programación I” (calculado en forma de promedio).
		 ...
		 * obtuvo cada estudiante en los examenes de la materia “Programación I” y su promedio. Tener en cuenta que
		 * cada estudiante tiene uno y solo un registro de calificaciones asociado.
		 ...
		 * GET /calificaciones/ordendesc: Devuelve las calificaciones de todos los estudiantes, junto con el nombre
		 * de cada uno de ellos ordenados de forma descendente (mayor calificación primero, menor a lo último)
		 **/
	}
